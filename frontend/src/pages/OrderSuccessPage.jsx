...
import { CheckCircle, Download, Home, Ticket, Share2 } from 'lucide-react';
...
export default function OrderSuccessPage() {
  ...
  // Use normalized order throughout the page
  ...
  return (
    <>
      <Helmet><title>Заказ оформлен — TicketHub</title></Helmet>
        ...
        <div className="max-w-lg w-full mx-auto px-4">
          ...
          >
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              <h1 className="font-display text-3xl font-black mb-2">Оплата прошла!</h1>
              <p className="text-white/50 mb-8">Билеты отправлены на ваш email</p>
            </motion.div>
              ...
              {o.qrCode && (
                <div className="mt-4 flex justify-center">
                  <div className="p-3 bg-white rounded-xl">
                    <img src={o.qrCode} alt="QR билет" className="w-32 h-32" />
                  </div>
                </div>
              )}
            </motion.div>
            ...
            >
              <Link to="/orders" className="btn-primary flex items-center justify-center gap-2 py-3">
                <Ticket className="w-5 h-5" /> Мои билеты
              </Link>
