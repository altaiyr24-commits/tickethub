...
export default function LoginPage() {
  ...
  return (
    <>
      <Helmet><title>Войти — TicketHub</title></Helmet>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 pt-16">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-3xl font-black mb-2">Добро пожаловать</h1>
            <p className="text-white/40">Войдите в свой аккаунт</p>
          </div>
          ...
          <div className="glass-card p-8">
            ...
            <div className="glass rounded-xl p-4 mb-4">
              <p className="text-xs text-white/40 mb-2 font-semibold uppercase tracking-wider">Демо аккаунты</p>
